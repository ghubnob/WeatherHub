...
public class MainController {
    ...
    public String getMainPage(HttpServletRequest request, Model model) {
        return userService.onMainPage(request, model);
    }
